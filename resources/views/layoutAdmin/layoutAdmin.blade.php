...
<body>
    <div class="sidebar">
        ...
        <ul class="nav_list">
            <li>
                ...
                <!-- Lát mình sẽ CSS cho phần này, nên cứ comment ở đây đã nhé -->
            </li>
            <li>
            ...
            <li>
                <a href="{{route('admin.showAllProduct')}}">
            ...
            <li>
                <a href="{{route('admin.showAllOrder')}}">
        ...
        <div class="container_home">
            <div class="container_content-comback">
                ...
                <div class="container_home_directory">
                   <!--Điều Hướng Here-->
                    <a href="{{route('admin.show')}}">Admin</a> @yield('directory')
                    <!--End Điều Hướng Here-->        
                                   
                </div>
                
                <div class="container_content-logo_admin">                 
                     <a href="{{route('product.home')}}"> <i class="fa-solid fa-globe"></i></a>
    ...
    <div class="settings">
        ...
        <div class="settings_controller hide">
            ...
            <h4>MY WEBSITE </h4>
            <button class="sidebar_vip blue"><a href="{{route('product.home')}}">GOTO WEBSITE</a></button>
        </div>
    </div>
